...
class StockTransactionsApi
{
     ...
     */
    public function createStockTransaction($str_database, $create_or_update_stock_transaction_request = null)
    {
        list($response) = $this->createStockTransactionWithHttpInfo($str_database, $create_or_update_stock_transaction_request);
        return $response;
    }
     ...
     */
    public function createStockTransactionWithHttpInfo($str_database, $create_or_update_stock_transaction_request = null)
    {
        $request = $this->createStockTransactionRequest($str_database, $create_or_update_stock_transaction_request);
     ...
     */
    public function createStockTransactionAsync($str_database, $create_or_update_stock_transaction_request = null)
    {
        return $this->createStockTransactionAsyncWithHttpInfo($str_database, $create_or_update_stock_transaction_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createStockTransactionAsyncWithHttpInfo($str_database, $create_or_update_stock_transaction_request = null)
    {
        $returnType = '\iPosExchanger\Model\CreateRecordResponse';
        $request = $this->createStockTransactionRequest($str_database, $create_or_update_stock_transaction_request);
     ...
     */
    public function createStockTransactionRequest($str_database, $create_or_update_stock_transaction_request = null)
    {
