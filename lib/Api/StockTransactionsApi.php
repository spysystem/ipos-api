...
class StockTransactionsApi
{
     ...
     */
    public function createStockTransaction($str_database, $data = null)
    {
        list($response) = $this->createStockTransactionWithHttpInfo($str_database, $data);
        return $response;
    }
     ...
     */
    public function createStockTransactionWithHttpInfo($str_database, $data = null)
    {
        $request = $this->createStockTransactionRequest($str_database, $data);
     ...
     */
    public function createStockTransactionAsync($str_database, $data = null)
    {
        return $this->createStockTransactionAsyncWithHttpInfo($str_database, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createStockTransactionAsyncWithHttpInfo($str_database, $data = null)
    {
        $returnType = '\iPosExchanger\Model\CreateRecordResponse';
        $request = $this->createStockTransactionRequest($str_database, $data);
     ...
     */
    public function createStockTransactionRequest($str_database, $data = null)
    {
     ...
     */
    public function findStockTransactions($str_database, $data = null)
    {
        list($response) = $this->findStockTransactionsWithHttpInfo($str_database, $data);
        return $response;
    }
     ...
     */
    public function findStockTransactionsWithHttpInfo($str_database, $data = null)
    {
        $request = $this->findStockTransactionsRequest($str_database, $data);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findStockTransactionsAsync($str_database, $data = null)
    {
        return $this->findStockTransactionsAsyncWithHttpInfo($str_database, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findStockTransactionsAsyncWithHttpInfo($str_database, $data = null)
    {
        $returnType = '\iPosExchanger\Model\FindStockTransactionResponse';
        $request = $this->findStockTransactionsRequest($str_database, $data);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function findStockTransactionsRequest($str_database, $data = null)
    {
     ...
     */
    public function updateStockTransaction($str_database, $i_record_id, $data = null)
    {
        list($response) = $this->updateStockTransactionWithHttpInfo($str_database, $i_record_id, $data);
        return $response;
    }
     ...
     */
    public function updateStockTransactionWithHttpInfo($str_database, $i_record_id, $data = null)
    {
        $request = $this->updateStockTransactionRequest($str_database, $i_record_id, $data);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStockTransactionAsync($str_database, $i_record_id, $data = null)
    {
        return $this->updateStockTransactionAsyncWithHttpInfo($str_database, $i_record_id, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStockTransactionAsyncWithHttpInfo($str_database, $i_record_id, $data = null)
    {
        $returnType = '\iPosExchanger\Model\DefaultResponseObject';
        $request = $this->updateStockTransactionRequest($str_database, $i_record_id, $data);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateStockTransactionRequest($str_database, $i_record_id, $data = null)
    {
