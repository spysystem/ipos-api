...
class ProductTypesApi
{
    ...
    public function createProductTypeRequest($str_database, $create_or_update_product_type_request = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($create_or_update_product_type_request)) {
            $_tempBody = $create_or_update_product_type_request;
        }
     ...
     *
     * @param  string $str_database Target Database in FileMaker (required)
     * @param  \iPosExchanger\Model\FindProductTypeRequest $find_product_type_request Search data (optional)
     *
     * @throws \iPosExchanger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function findProductTypes($str_database, $find_product_type_request = null)
    {
        list($response) = $this->findProductTypesWithHttpInfo($str_database, $find_product_type_request);
        return $response;
    }
     ...
     */
    public function findProductTypesWithHttpInfo($str_database, $find_product_type_request = null)
    {
        $request = $this->findProductTypesRequest($str_database, $find_product_type_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findProductTypesAsync($str_database, $find_product_type_request = null)
    {
        return $this->findProductTypesAsyncWithHttpInfo($str_database, $find_product_type_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findProductTypesAsyncWithHttpInfo($str_database, $find_product_type_request = null)
    {
        $returnType = '\iPosExchanger\Model\FindProductTypeResponse';
        $request = $this->findProductTypesRequest($str_database, $find_product_type_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function findProductTypesRequest($str_database, $find_product_type_request = null)
    {
        // verify the required parameter 'str_database' is set
        if ($str_database === null || (is_array($str_database) && count($str_database) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // body params
        $_tempBody = null;
        if (isset($find_product_type_request)) {
            $_tempBody = $find_product_type_request;
        }
