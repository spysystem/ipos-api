...
class SalesReportsApi
{
     ...
     */
    public function findSalesReports($str_database, $data = null)
    {
        list($response) = $this->findSalesReportsWithHttpInfo($str_database, $data);
        return $response;
    }
     ...
     */
    public function findSalesReportsWithHttpInfo($str_database, $data = null)
    {
        $request = $this->findSalesReportsRequest($str_database, $data);
     ...
     */
    public function findSalesReportsAsync($str_database, $data = null)
    {
        return $this->findSalesReportsAsyncWithHttpInfo($str_database, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findSalesReportsAsyncWithHttpInfo($str_database, $data = null)
    {
        $returnType = '\iPosExchanger\Model\FindSalesReportResponse';
        $request = $this->findSalesReportsRequest($str_database, $data);
     ...
     */
    public function findSalesReportsRequest($str_database, $data = null)
    {
     ...
     */
    public function updateSalesReport($str_database, $i_record_id, $data = null)
    {
        list($response) = $this->updateSalesReportWithHttpInfo($str_database, $i_record_id, $data);
        return $response;
    }
     ...
     */
    public function updateSalesReportWithHttpInfo($str_database, $i_record_id, $data = null)
    {
        $request = $this->updateSalesReportRequest($str_database, $i_record_id, $data);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSalesReportAsync($str_database, $i_record_id, $data = null)
    {
        return $this->updateSalesReportAsyncWithHttpInfo($str_database, $i_record_id, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSalesReportAsyncWithHttpInfo($str_database, $i_record_id, $data = null)
    {
        $returnType = '\iPosExchanger\Model\DefaultResponseObject';
        $request = $this->updateSalesReportRequest($str_database, $i_record_id, $data);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateSalesReportRequest($str_database, $i_record_id, $data = null)
    {
