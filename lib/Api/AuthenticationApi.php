...
class AuthenticationApi
{
     ...
     */
    public function getDataToken($str_database, $data = null)
    {
        list($response) = $this->getDataTokenWithHttpInfo($str_database, $data);
        return $response;
    }
     ...
     */
    public function getDataTokenWithHttpInfo($str_database, $data = null)
    {
        $request = $this->getDataTokenRequest($str_database, $data);
     ...
     */
    public function getDataTokenAsync($str_database, $data = null)
    {
        return $this->getDataTokenAsyncWithHttpInfo($str_database, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDataTokenAsyncWithHttpInfo($str_database, $data = null)
    {
        $returnType = '\iPosExchanger\Model\AuthenticationResponseObject';
        $request = $this->getDataTokenRequest($str_database, $data);
     ...
     */
    public function getDataTokenRequest($str_database, $data = null)
    {
