...
/**
     ...
     * @param  \iPosExchanger\Model\CreateOrUpdateDeliveryRequest $data Record to be created (optional)
     ...
     */
    public function createDelivery($str_database, $data = null, string $contentType = self::contentTypes['createDelivery'][0])
    {
        list($response) = $this->createDeliveryWithHttpInfo($str_database, $data, $contentType);
        return $response;
    }
     ...
     */
    public function createDeliveryWithHttpInfo($str_database, $data = null, string $contentType = self::contentTypes['createDelivery'][0])
    {
        $request = $this->createDeliveryRequest($str_database, $data, $contentType);
     ...
     */
    public function createDeliveryAsync($str_database, $data = null, string $contentType = self::contentTypes['createDelivery'][0])
    {
        return $this->createDeliveryAsyncWithHttpInfo($str_database, $data, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createDeliveryAsyncWithHttpInfo($str_database, $data = null, string $contentType = self::contentTypes['createDelivery'][0])
    {
        $returnType = '\iPosExchanger\Model\CreateRecordResponse';
        $request = $this->createDeliveryRequest($str_database, $data, $contentType);
     ...
     */
    public function createDeliveryRequest($str_database, $data = null, string $contentType = self::contentTypes['createDelivery'][0])
    {
