...
class DeliveriesApi
{
     ...
     */
    public function createDelivery($str_database, $data = null)
    {
        list($response) = $this->createDeliveryWithHttpInfo($str_database, $data);
        return $response;
    }
     ...
     */
    public function createDeliveryWithHttpInfo($str_database, $data = null)
    {
        $request = $this->createDeliveryRequest($str_database, $data);
     ...
     */
    public function createDeliveryAsync($str_database, $data = null)
    {
        return $this->createDeliveryAsyncWithHttpInfo($str_database, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createDeliveryAsyncWithHttpInfo($str_database, $data = null)
    {
        $returnType = '\iPosExchanger\Model\CreateRecordResponse';
        $request = $this->createDeliveryRequest($str_database, $data);
     ...
     */
    public function createDeliveryRequest($str_database, $data = null)
    {
