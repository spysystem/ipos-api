...
class DeliveryLinesApi
{
     ...
     * @param  \iPosExchanger\Model\CreateOrUpdateDeliveryLineRequest $create_or_update_delivery_line_request Record to be created (optional)
     *
    ...
    {
        list($response) = $this->createDeliveryLineWithHttpInfo($str_database, $create_or_update_delivery_line_request);
        return $response;
    }
    ...
    {
        $request = $this->createDeliveryLineRequest($str_database, $create_or_update_delivery_line_request);
     ...
     */
    public function createDeliveryLineAsync($str_database, $create_or_update_delivery_line_request = null)
    {
        return $this->createDeliveryLineAsyncWithHttpInfo($str_database, $create_or_update_delivery_line_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createDeliveryLineAsyncWithHttpInfo($str_database, $create_or_update_delivery_line_request = null)
    {
        $returnType = '\iPosExchanger\Model\CreateRecordResponse';
        $request = $this->createDeliveryLineRequest($str_database, $create_or_update_delivery_line_request);
     ...
     */
    public function createDeliveryLineRequest($str_database, $create_or_update_delivery_line_request = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($create_or_update_delivery_line_request)) {
            $_tempBody = $create_or_update_delivery_line_request;
        }
