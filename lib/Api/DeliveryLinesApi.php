...
class DeliveryLinesApi
{
     ...
     */
    public function createDeliveryLine($str_database, $data = null)
    {
        list($response) = $this->createDeliveryLineWithHttpInfo($str_database, $data);
        return $response;
    }
     ...
     */
    public function createDeliveryLineWithHttpInfo($str_database, $data = null)
    {
        $request = $this->createDeliveryLineRequest($str_database, $data);
     ...
     */
    public function createDeliveryLineAsync($str_database, $data = null)
    {
        return $this->createDeliveryLineAsyncWithHttpInfo($str_database, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createDeliveryLineAsyncWithHttpInfo($str_database, $data = null)
    {
        $returnType = '\iPosExchanger\Model\CreateRecordResponse';
        $request = $this->createDeliveryLineRequest($str_database, $data);
     ...
     */
    public function createDeliveryLineRequest($str_database, $data = null)
    {
