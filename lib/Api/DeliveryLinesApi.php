...
/**
 * DeliveryLinesApi Class Doc Comment
 *
 * @category Class
 * @package  iPosExchanger
 * @author   OpenAPI Generator team
...
/**
     ...
     * @param  \iPosExchanger\Model\CreateOrUpdateDeliveryLineRequest $data Record to be created (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createDeliveryLine'] to see the possible values for this operation
     *
     ...
     */
    public function createDeliveryLine($str_database, $data = null, string $contentType = self::contentTypes['createDeliveryLine'][0])
    {
        list($response) = $this->createDeliveryLineWithHttpInfo($str_database, $data, $contentType);
        return $response;
    }
     ...
     */
    public function createDeliveryLineWithHttpInfo($str_database, $data = null, string $contentType = self::contentTypes['createDeliveryLine'][0])
    {
        $request = $this->createDeliveryLineRequest($str_database, $data, $contentType);
     ...
     */
    public function createDeliveryLineAsync($str_database, $data = null, string $contentType = self::contentTypes['createDeliveryLine'][0])
    {
        return $this->createDeliveryLineAsyncWithHttpInfo($str_database, $data, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createDeliveryLineAsyncWithHttpInfo($str_database, $data = null, string $contentType = self::contentTypes['createDeliveryLine'][0])
    {
        $returnType = '\iPosExchanger\Model\CreateRecordResponse';
        $request = $this->createDeliveryLineRequest($str_database, $data, $contentType);
     ...
     */
    public function createDeliveryLineRequest($str_database, $data = null, string $contentType = self::contentTypes['createDeliveryLine'][0])
    {

        // verify the required parameter 'str_database' is set
        if ($str_database === null || (is_array($str_database) && count($str_database) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $str_database when calling createDeliveryLine'
            );
        }



        $resourcePath = '/{strDatabase}/layouts/api_SPY_Varemodtagelse_linie/records';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
