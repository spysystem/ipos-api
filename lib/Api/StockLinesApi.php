...
class StockLinesApi
{
     ...
     */
    public function createStockLine($str_database, $data = null)
    {
        list($response) = $this->createStockLineWithHttpInfo($str_database, $data);
        return $response;
    }
     ...
     */
    public function createStockLineWithHttpInfo($str_database, $data = null)
    {
        $request = $this->createStockLineRequest($str_database, $data);
     ...
     */
    public function createStockLineAsync($str_database, $data = null)
    {
        return $this->createStockLineAsyncWithHttpInfo($str_database, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createStockLineAsyncWithHttpInfo($str_database, $data = null)
    {
        $returnType = '\iPosExchanger\Model\DefaultResponseObject';
        $request = $this->createStockLineRequest($str_database, $data);
     ...
     */
    public function createStockLineRequest($str_database, $data = null)
    {
     ...
     */
    public function findStockLines($str_database, $data = null)
    {
        list($response) = $this->findStockLinesWithHttpInfo($str_database, $data);
        return $response;
    }
     ...
     */
    public function findStockLinesWithHttpInfo($str_database, $data = null)
    {
        $request = $this->findStockLinesRequest($str_database, $data);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findStockLinesAsync($str_database, $data = null)
    {
        return $this->findStockLinesAsyncWithHttpInfo($str_database, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findStockLinesAsyncWithHttpInfo($str_database, $data = null)
    {
        $returnType = '\iPosExchanger\Model\FindStockItemsResponse';
        $request = $this->findStockLinesRequest($str_database, $data);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function findStockLinesRequest($str_database, $data = null)
    {
     ...
     * @return \iPosExchanger\Model\DefaultResponseObject|\iPosExchanger\Model\DefaultResponseObject|\iPosExchanger\Model\DefaultResponseObject|\iPosExchanger\Model\DefaultResponseObject
     */
    public function updateStockLine($str_database, $i_record_id, $data = null)
    {
        list($response) = $this->updateStockLineWithHttpInfo($str_database, $i_record_id, $data);
        return $response;
    }
     ...
     * @return array of \iPosExchanger\Model\DefaultResponseObject|\iPosExchanger\Model\DefaultResponseObject|\iPosExchanger\Model\DefaultResponseObject|\iPosExchanger\Model\DefaultResponseObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateStockLineWithHttpInfo($str_database, $i_record_id, $data = null)
    {
        $request = $this->updateStockLineRequest($str_database, $i_record_id, $data);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStockLineAsync($str_database, $i_record_id, $data = null)
    {
        return $this->updateStockLineAsyncWithHttpInfo($str_database, $i_record_id, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStockLineAsyncWithHttpInfo($str_database, $i_record_id, $data = null)
    {
        $returnType = '\iPosExchanger\Model\DefaultResponseObject';
        $request = $this->updateStockLineRequest($str_database, $i_record_id, $data);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateStockLineRequest($str_database, $i_record_id, $data = null)
    {
