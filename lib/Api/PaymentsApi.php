...
/**
     ...
     */
    public function findPayments($str_database, $data = null, string $contentType = self::contentTypes['findPayments'][0])
    {
        list($response) = $this->findPaymentsWithHttpInfo($str_database, $data, $contentType);
        return $response;
    }
     ...
     */
    public function findPaymentsWithHttpInfo($str_database, $data = null, string $contentType = self::contentTypes['findPayments'][0])
    {
        $request = $this->findPaymentsRequest($str_database, $data, $contentType);
     ...
     */
    public function findPaymentsAsync($str_database, $data = null, string $contentType = self::contentTypes['findPayments'][0])
    {
        return $this->findPaymentsAsyncWithHttpInfo($str_database, $data, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findPaymentsAsyncWithHttpInfo($str_database, $data = null, string $contentType = self::contentTypes['findPayments'][0])
    {
        $returnType = '\iPosExchanger\Model\FindPaymentsResponse';
        $request = $this->findPaymentsRequest($str_database, $data, $contentType);
     ...
     */
    public function findPaymentsRequest($str_database, $data = null, string $contentType = self::contentTypes['findPayments'][0])
    {
     ...
     * @return \iPosExchanger\Model\FindPaymentsResponse|\iPosExchanger\Model\DefaultResponseObject|\iPosExchanger\Model\DefaultResponseObject|\iPosExchanger\Model\DefaultResponseObject
     */
    public function getPayment($str_database, $i_record_id, string $contentType = self::contentTypes['getPayment'][0])
    {
        list($response) = $this->getPaymentWithHttpInfo($str_database, $i_record_id, $contentType);
        return $response;
    }
     ...
     * @return array of \iPosExchanger\Model\FindPaymentsResponse|\iPosExchanger\Model\DefaultResponseObject|\iPosExchanger\Model\DefaultResponseObject|\iPosExchanger\Model\DefaultResponseObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentWithHttpInfo($str_database, $i_record_id, string $contentType = self::contentTypes['getPayment'][0])
    {
        $request = $this->getPaymentRequest($str_database, $i_record_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentAsync($str_database, $i_record_id, string $contentType = self::contentTypes['getPayment'][0])
    {
        return $this->getPaymentAsyncWithHttpInfo($str_database, $i_record_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentAsyncWithHttpInfo($str_database, $i_record_id, string $contentType = self::contentTypes['getPayment'][0])
    {
        $returnType = '\iPosExchanger\Model\FindPaymentsResponse';
        $request = $this->getPaymentRequest($str_database, $i_record_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPaymentRequest($str_database, $i_record_id, string $contentType = self::contentTypes['getPayment'][0])
    {
     ...
     */
    public function updatePayment($str_database, $i_record_id, $data = null, string $contentType = self::contentTypes['updatePayment'][0])
    {
        list($response) = $this->updatePaymentWithHttpInfo($str_database, $i_record_id, $data, $contentType);
        return $response;
    }
     ...
     */
    public function updatePaymentWithHttpInfo($str_database, $i_record_id, $data = null, string $contentType = self::contentTypes['updatePayment'][0])
    {
        $request = $this->updatePaymentRequest($str_database, $i_record_id, $data, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePaymentAsync($str_database, $i_record_id, $data = null, string $contentType = self::contentTypes['updatePayment'][0])
    {
        return $this->updatePaymentAsyncWithHttpInfo($str_database, $i_record_id, $data, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePaymentAsyncWithHttpInfo($str_database, $i_record_id, $data = null, string $contentType = self::contentTypes['updatePayment'][0])
    {
        $returnType = '\iPosExchanger\Model\DefaultResponseObject';
        $request = $this->updatePaymentRequest($str_database, $i_record_id, $data, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updatePaymentRequest($str_database, $i_record_id, $data = null, string $contentType = self::contentTypes['updatePayment'][0])
    {
