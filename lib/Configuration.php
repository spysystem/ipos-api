...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://fm.macpartner.dk/fmi/data/v1/databases';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/1.8.0.1/PHP';
    ...
    {
        $report  = 'PHP SDK (iPosExchanger) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0.0' . PHP_EOL;
        $report .= '    SDK Package Version: 1.8.0.1' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://fm.macpartner.dk/fmi/data/v1/databases",
