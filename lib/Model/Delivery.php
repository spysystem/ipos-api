...
class Delivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return DeliveryModelFields
      */
    public static function GetModelFields(): DeliveryModelFields
    {
        return new DeliveryModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return DeliveryModelAttributes
      */
    public static function GetModelAttributes(): DeliveryModelAttributes
    {
        return new DeliveryModelAttributes();
    }
    ...
    {
        $this->setIfExists('id_uuid', $data ?? [], null);
        $this->setIfExists('id_lokation', $data ?? [], null);
        $this->setIfExists('dato_opr', $data ?? [], null);
    }
    ...
    */
    ...
    public function setIdUuid($id_uuid)
    {
        ...
        if (is_null($id_uuid)) {
            throw new \InvalidArgumentException('non-nullable id_uuid cannot be null');
        }
    ...
    public function setDatoOpr($dato_opr)
    {
        ...
        if (is_null($dato_opr)) {
            throw new \InvalidArgumentException('non-nullable dato_opr cannot be null');
        }
